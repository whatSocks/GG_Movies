...
[source,cypher]
----
LOAD CSV FROM 'https://raw.githubusercontent.com/whatSocks/GG_Movies/master/movies.csv' AS line FIELDTERMINATOR '|'
...
[source,cypher]
----
LOAD CSV FROM 'https://raw.githubusercontent.com/whatSocks/GG_Movies/master/persons.csv' AS line FIELDTERMINATOR '|'
...
[source,cypher]
----
LOAD CSV FROM 'https://raw.githubusercontent.com/whatSocks/GG_Movies/master/acted_in.csv' AS line FIELDTERMINATOR '|'
